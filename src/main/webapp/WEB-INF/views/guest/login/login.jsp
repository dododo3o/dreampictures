    ...
    <div class="container">
        <div class="contents" style="grid-column: 5/9; margin-top: 85px">
            <form action="<%=conPath%>/login_check" method="post" id="frm">
                <div style="display: flex;flex-direction: column;justify-content: space-evenly;height: 650px; ">
                    <div class="title">로그인 화면</div>
                    <div class="has_flex_left"><input type="text" placeholder="Email" name="email" id="email" class="is_login_input"/></div>
                    <div class="has_flex_left"><input type="password" placeholder="Password" name="pwd" id="pwd" class="is_login_input"/></div>
