...
<%--                <div><img src="${cardVOlist.avatarimg}" style="border-radius:50%;width:7em;height:7em; object-fit:cover;"></div>--%>
...
<%--                <div style="display:flex; justify-content: space-evenly;">--%>
<%--                    <a href="/charge"><button class="ui blue icon button" style="width:200px; height:50px; ">포인트충전</button></a>--%>
<%--                    <button class="ui blue icon button" style="width:200px; height:50px;">수정하기</button>--%>
<%--                    <button class="ui blue icon button" style="width:200px; height:50px;">탈퇴하기</button></div>--%>
<%--            </div>--%>
<%--        </div>--%>
